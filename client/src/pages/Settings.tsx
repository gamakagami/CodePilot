      ...
      <div className="space-y-8">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid gap-4">
              <div className="grid gap-2">
                ...
                <Input id="fullName" defaultValue="Developer" />
              </div>

              <div className="grid gap-2">
                <Label htmlFor="username">GitHub Username</Label>
                <Input id="username" value="developer" disabled />
                <p className="text-xs text-muted-foreground">Your GitHub username cannot be changed</p>
              </div>
            ...
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Input 
                  ...
                  disabled 
                />
                <p className="text-xs text-muted-foreground">Generated via OAuth authentication</p>
              </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Configure AI model behavior and thresholds</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <div className="space-y-4">
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-muted-foreground">0.70</span>
                </div>
                <Slider 
                  id="riskThreshold"
                  defaultValue={[70]} 
                ...
                <p className="text-xs text-muted-foreground">
                  PRs with failure probability above this threshold will be flagged as high risk
                </p>
              </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Current application and model versions</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-foreground font-medium mt-1">2025-01-10</p>
              </div>
            </div>
